...
#include <cstring> // Include cstring for strlen and vsprintf
#include "gfx.h"
#include "font.h"
#include "gfxfont.h"
...
{
    // fixed casting issue
    void *some_void_pointer = malloc(_width * _height * sizeof(uint16_t));

    gfxFramebuffer = static_cast<uint16_t *>(some_void_pointer);
}
